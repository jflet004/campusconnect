...
c1	=	Course.create(title: 'Art I', start_time: DateTime.new(2023,3,1,9,30), end_time: DateTime.new(2023,3,1,11,0), location: r20.name, price: 19, capacity: 10, days_of_week: ["2","4"])
c2	=	Course.create(title: 'Art II', start_time: DateTime.new(2023,3,1,9,0), end_time: DateTime.new(2023,3,1,10,0), location: r21.name, price: 19, capacity: 10, days_of_week: ["2"])
c3	=	Course.create(title: 'Portfolio Development', start_time: DateTime.new(2023,3,1,11,0), end_time: DateTime.new(2023,3,1,12,30), location: r20.name, price: 19, capacity: 10, days_of_week: ["1"])
c4	=	Course.create(title: 'Art for the Young', start_time: DateTime.new(2023,3,1,13,0), end_time: DateTime.new(2023,3,1,14,30), location: r20.name, price: 19, capacity: 10, days_of_week: ["2","4"])
c5	=	Course.create(title: 'Visual Art For Adults', start_time: DateTime.new(2023,3,1,18,0), end_time: DateTime.new(2023,3,1,19,0), location: r21.name, price: 19, capacity: 10, days_of_week: ["3","4"])
