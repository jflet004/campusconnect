...
c2	=	Course.create(title: 'Art II', start_time: DateTime.new(2023,3,1,9,0), end_time: DateTime.new(2023,3,1,10,0), location: r21.name, price: 19, capacity: 10, teacher_id: t2.id, days_of_week: ["2","4"])
c3	=	Course.create(title: 'Portfolio Development', start_time: DateTime.new(2023,3,1,11,0), end_time: DateTime.new(2023,3,1,12,30), location: r20.name, price: 19, capacity: 10, teacher_id: t3.id, days_of_week: ["2","4"])
...
c5	=	Course.create(title: 'Visual Art For Adults', start_time: DateTime.new(2023,3,1,18,0), end_time: DateTime.new(2023,3,1,19,0), location: r21.name, price: 19, capacity: 10, teacher_id: t15.id, days_of_week: ["2","4"])
