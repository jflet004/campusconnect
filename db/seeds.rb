...
# t1	=	Teacher.create(first_name: 'Aaron', last_name: 'Estrada', email: 'estra711@gmail.com', active: 'true', phone_number: '714-398-2878', address: '796 Main St', city: 'San Fernando', state: 'CA', postal_code: '93142', gender: "male")
# t2	=	Teacher.create(first_name: 'Adzua', last_name: 'Amoa', email: 'ashaamoa11@gmail.com', active: 'true', phone_number: '804-809-7698', address: '704 Pine St', city: 'San Fernando', state: 'CA', postal_code: '92072', gender: "female")
# t3	=	Teacher.create(first_name: 'Anna', last_name: 'Antonian', email: 'annaantonian@yahoo.com', active: 'true', phone_number: '779-892-8447', address: '031 Oak St', city: 'Hawthorne', state: 'CA', postal_code: '92571', gender: "female")
# t4	=	Teacher.create(first_name: 'Arturo', last_name: 'Gonzalez', email: 'arturo1gonz@gmail.com', active: 'true', phone_number: '233-382-5309', address: '259 Elm St', city: 'Lancaster', state: 'CA', postal_code: '91560', gender: "male")
# t5	=	Teacher.create(first_name: 'Brendan', last_name: 'White', email: 'brendanwhitepiano@gmail.com', active: 'true', phone_number: '234-396-8692', address: '453 Main St', city: 'Culver City', state: 'CA', postal_code: '91556', gender: "male")
# t6	=	Teacher.create(first_name: 'Bridget', last_name: 'Risemberg', email: 'brisembe@gmail.com', active: 'true', phone_number: '734-148-6502', address: '662 Oak St', city: 'Compton', state: 'CA', postal_code: '91280', gender: "female")
# t7	=	Teacher.create(first_name: 'Chris', last_name: 'Moore', email: 'Chrizmo@earthlink.net', active: 'true', phone_number: '293-537-4623', address: '697 Elm St', city: 'Brentwood', state: 'CA', postal_code: '93415', gender: "male")
# t8	=	Teacher.create(first_name: 'Emily', last_name: 'Nastelin', email: 'nastelin@usc.edu', active: 'true', phone_number: '283-737-1506', address: '084 Main St', city: 'Culver City', state: 'CA', postal_code: '92528', gender: "female")
# t9	=	Teacher.create(first_name: 'Eric', last_name: 'Gold', email: 'ericgoldrock@yahoo.com', active: 'true', phone_number: '329-313-5462', address: '656 Oak St', city: 'Santa Monica', state: 'CA', postal_code: '90158', gender: "male")
# t10	=	Teacher.create(first_name: 'Eric', last_name: 'Linnes-Bagley', email: 'ericlinnesbagley@gmail.com', active: 'true', phone_number: '954-422-6262', address: '493 Oak St', city: 'Beverly Hills', state: 'CA', postal_code: '90449', gender: "male")
# t11	=	Teacher.create(first_name: 'Evan', last_name: 'Enderle', email: 'emenderle@gmail.com', active: 'true', phone_number: '102-210-1958', address: '207 Main St', city: 'Burbank', state: 'CA', postal_code: '92107', gender: "male")
# t12	=	Teacher.create(first_name: 'Hazle', last_name: 'Thunes', email: 'hazlethunes@gmail.com', active: 'true', phone_number: '166-773-7215', address: '640 Pine St', city: 'Santa Monica', state: 'CA', postal_code: '93025', gender: "female")
# t13	=	Teacher.create(first_name: 'Isaac', last_name: 'Johnson', email: 'isaacschannojohnson@gmail.com', active: 'true', phone_number: '837-357-5069', address: '652 Elm St', city: 'Compton', state: 'CA', postal_code: '90945', gender: "male")
# t14	=	Teacher.create(first_name: 'Isaac', last_name: 'Lopez', email: 'izzynator88@gmail.com', active: 'true', phone_number: '634-541-1165', address: '200 Elm St', city: 'Hawthorne', state: 'CA', postal_code: '91113', gender: "male")
# t15	=	Teacher.create(first_name: 'James', last_name: 'Hober', email: 'jhober@earthlink.net', active: 'true', phone_number: '220-866-1759', address: '606 Main St', city: 'Pomona', state: 'CA', postal_code: '91581', gender: "male")
# t16	=	Teacher.create(first_name: 'Joan', last_name: 'Fricke', email: 'jhpfricke@gmail.com', active: 'true', phone_number: '723-874-3301', address: '772 Elm St', city: 'Long Beach', state: 'CA', postal_code: '91089', gender: "female")
# t17	=	Teacher.create(first_name: 'Juan', last_name: 'Gamez', email: 'jcgp_1994@yahoo.es', active: 'true', phone_number: '315-488-4219', address: '669 Elm St', city: 'Hawthorne', state: 'CA', postal_code: '91570', gender: "male")
# t18	=	Teacher.create(first_name: 'Julian', last_name: 'Kim', email: 'jaeyoungk.pf@gmail.com', active: 'true', phone_number: '363-401-1263', address: '603 Elm St', city: 'Culver City', state: 'CA', postal_code: '90292', gender: "male")
# t19	=	Teacher.create(first_name: 'Mana', last_name: 'Azimi', email: 'azimimana23@gmail.com', active: 'true', phone_number: '602-583-7124', address: '238 Main St', city: 'Calabasas', state: 'CA', postal_code: '91726', gender: "female")
# t20	=	Teacher.create(first_name: 'Nadia', last_name: 'Aponte', email: 'naponte14@gmail.com', active: 'true', phone_number: '714-398-2879', address: '873 Pine St', city: 'Malibu', state: 'CA', postal_code: '92096', gender: "female")
# t21	=	Teacher.create(first_name: 'Nicholas', last_name: 'Del Valle', email: 'mendezn@usc.edu', active: 'true', phone_number: '804-809-7699', address: '797 Main St', city: 'San Fernando', state: 'CA', postal_code: '93142', gender: "male")
# t22	=	Teacher.create(first_name: 'Noe', last_name: 'Pina', email: 'noepinafineart@gmail.com', active: 'true', phone_number: '779-892-8448', address: '705 Pine St', city: 'San Fernando', state: 'CA', postal_code: '92072', gender: "male")
# t23	=	Teacher.create(first_name: 'Reed', last_name: 'Campbell', email: 'soupyrmc@gmail.com', active: 'true', phone_number: '233-382-5310', address: '32 Oak St', city: 'Hawthorne', state: 'CA', postal_code: '92571', gender: "male")
# t24	=	Teacher.create(first_name: 'Richard', last_name: 'An', email: 'richardanmusic@gmail.com', active: 'true', phone_number: '234-396-8693', address: '260 Elm St', city: 'Lancaster', state: 'CA', postal_code: '91560', gender: "male")
# t25	=	Teacher.create(first_name: 'Rubi', last_name: 'Castillo', email: 'rcastillo.music@gmail.com', active: 'true', phone_number: '734-148-6503', address: '454 Main St', city: 'Culver City', state: 'CA', postal_code: '91556', gender: "female")
# t26	=	Teacher.create(first_name: 'Shalese', last_name: 'Sedgwick', email: 'shalesemurphy@gmail.com', active: 'true', phone_number: '293-537-4624', address: '663 Oak St', city: 'Compton', state: 'CA', postal_code: '91280', gender: "female")
# t27	=	Teacher.create(first_name: 'Tara', last_name: 'Sanchez', email: 'taraberlin21@gmail.com', active: 'true', phone_number: '283-737-1507', address: '698 Elm St', city: 'Brentwood', state: 'CA', postal_code: '93415', gender: "female")
# t28	=	Teacher.create(first_name: 'Timothy', last_name: 'Maloof', email: 'mysterio67@yahoo.com', active: 'true', phone_number: '329-313-5463', address: '85 Main St', city: 'Culver City', state: 'CA', postal_code: '92528', gender: "male")
...
c1	=	Course.create(title: 'Art I', start_time: DateTime.new(2023,3,1,9,30), end_time: DateTime.new(2023,3,1,11,0), location: r20.name, price: 19, capacity: 10, start_recur: DateTime.new(2023,3,1,9,0), days_of_week: ["2","4"])
c2	=	Course.create(title: 'Art II', start_time: DateTime.new(2023,3,1,9,0), end_time: DateTime.new(2023,3,1,10,0), location: r21.name, price: 19, capacity: 10, start_recur: DateTime.new(2023,3,1,9,0), days_of_week: ["2"])
c3	=	Course.create(title: 'Portfolio Development', start_time: DateTime.new(2023,3,1,11,0), end_time: DateTime.new(2023,3,1,12,30), location: r20.name, price: 19, capacity: 10, start_recur: DateTime.new(2023,3,1,9,0), days_of_week: ["1"])
c4	=	Course.create(title: 'Art for the Young', start_time: DateTime.new(2023,3,1,13,0), end_time: DateTime.new(2023,3,1,14,30), location: r20.name, price: 19, capacity: 10, start_recur: DateTime.new(2023,3,1,9,0), days_of_week: ["2","4"])
c5	=	Course.create(title: 'Visual Art For Adults', start_time: DateTime.new(2023,3,1,18,0), end_time: DateTime.new(2023,3,1,19,0), location: r21.name, price: 19, capacity: 10, start_recur: DateTime.new(2023,3,1,9,0), days_of_week: ["3","4"])
