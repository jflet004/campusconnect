...
const AboutUs = () => {
  return (
    <div className="about-us-container">
      ...
      <p className='about-us-section-text'>Our team is made up of passionate individuals who are dedicated to making education more accessible and manageable for everyone. From our developers to our customer support team, everyone at CampusConnect is committed to providing the best possible experience for our users.</p>
      </div>
      <div className='about-us-section-container'>
      <h2 className='about-us-section-title'>Get in Touch</h2>
      <p className='about-us-section-text'>If you have any questions or feedback, we'd love to hear from you. You can reach us at <strong>joseangelfletes@gmail.com</strong>. Thank you for choosing CampusConnect.</p>
      </div>
    </div>
  )
}
